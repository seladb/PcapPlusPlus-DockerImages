...
sudo docker exec -i fedora26 bash -c "cd PcapPlusPlus && make install"
sudo docker exec -i fedora26 bash -c "cd PcapPlusPlus/Examples/Tutorials/Tutorial-HelloWorld && make -f Makefile.non_windows all && ./Tutorial-HelloWorld"
