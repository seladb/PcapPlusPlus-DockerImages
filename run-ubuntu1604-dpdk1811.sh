...
sudo docker exec -i ubuntu1604-dpdk1811 bash -c "cd PcapPlusPlus && make install"
sudo docker exec -i ubuntu1604-dpdk1811 bash -c "cd PcapPlusPlus/Examples/Tutorials/Tutorial-HelloWorld && make -f Makefile.non_windows all && ./Tutorial-HelloWorld"
